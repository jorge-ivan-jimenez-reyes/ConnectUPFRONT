...
interface GestionAcademicaData {
...
export const FormularioGestionAcademica: React.FC = () => {
  ...
  const [datos, setDatos] = useState<GestionAcademicaData>({
    actividadPuesto: '',
    institucion: '',
    fechaInicio: '',
    fechaFin: ''
  ...
  const handleInputChange = (campo: keyof GestionAcademicaData, valor: string) => {
  ...
  const handleGuardar = () => {
    console.log('Guardando gestión académica:', datos);
    guardarCV();
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border-2 border-dashed border-gray-300">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Gestión Académica</h2>
        </div>
        <div className="p-6">
