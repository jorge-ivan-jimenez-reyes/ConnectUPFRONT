...
interface ReconocimientosData {
  descripcion: string;
}

export const FormularioReconocimientos: React.FC = () => {
  ...
  const [datos, setDatos] = useState<ReconocimientosData>({
    descripcion: ''
  });

  const handleInputChange = (campo: keyof ReconocimientosData, valor: string) => {
  ...
  const handleGuardar = () => {
    console.log('Guardando reconocimientos:', datos);
    guardarCV();
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">Reconocimientos Obtenidos</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border-2 border-dashed border-gray-300">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Reconocimientos Obtenidos</h2>
        </div>
        <div className="p-6">
          {/* Descripción del premio o reconocimiento obtenido */}
          <div>
            ...
            <textarea
              ...
              placeholder="Describe el premio o reconocimiento obtenido..."
              rows={4}
