...
interface ProductosAcademicosData {
  tipoProducto: string;
  titulo: string;
...
export const FormularioProductosAcademicos: React.FC = () => {
  ...
  const [datos, setDatos] = useState<ProductosAcademicosData>({
    tipoProducto: '',
    titulo: '',
    fechaPublicacion: '',
    descripcion: ''
  ...
  const handleInputChange = (campo: keyof ProductosAcademicosData, valor: string) => {
  ...
  const handleGuardar = () => {
    console.log('Guardando productos académicos:', datos);
    guardarCV();
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">Productos Académicos</p>
          </div>
        </div>
      ...
      {/* Formulario de Productos Académicos */}
      <div className="bg-white rounded-2xl border-2 border-dashed border-gray-300">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Productos Académicos</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                type="text"
                value={datos.tipoProducto}
                onChange={(e) => handleInputChange('tipoProducto', e.target.value)}
                placeholder="Artículo, Libro, Capítulo, etc."
            ...
            <div>
              ...
              <input
                ...
                placeholder="Título del producto académico"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-brand-primary bg-white"
              />
            </div>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              placeholder="Descripción del producto académico..."
              rows={3}
