// Vista Login para Administradores
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Acceso de Administrador</h2>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-gray-600">
              ...
              <Link to={ROUTES.REGISTER_ADMIN} className="font-medium text-brand-primary hover:text-primary-700 transition-colors">
